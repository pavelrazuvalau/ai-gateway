...
from src.infrastructure.output import (  # noqa: E402
    Colors,
    print_error,
    print_info,
    print_success,
...
from src.platform_utils import (  # noqa: E402
    PlatformType,
...
def main():
    ...
    try:
        ...
        if requirements_file.exists():
            ...
            subprocess.run(
                [python_exe, "-m", "pip", "install", "colorama", "pyyaml"], check=True
            )
    ...
    print()
    print_info(
        "Or use ./setup.sh and ./start.sh scripts (they activate venv automatically)"
    )
